CubeSat: Сборка спутников из компонентов как конструктор. Этот репозиторий содержит лабораторные работы (backend) по курсу "Разработка интернет-приложений" в МГТУ им. Н.Э. Баумана.
